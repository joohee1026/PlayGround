...
def inference(REG_DIR=None):
    ...
    if REG_DIR is None:
        REG_DIR = "/data/volume/sinyu/TEST/EXP52_REG"

    # W_path = "/data/volume/sinyu/Exp51"
    # W = sorted(glob(join(W_path, "*.h5")))[-1]
    W = "/data/volume/sinyu/Exp52/025_0.26955_0.59534.h5"
    ...
    for i, f in enumerate(test_files):
        ...
        reg_mask = np.load(join(REG_DIR, CASE_ID+".npy"))
