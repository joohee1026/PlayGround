...
def inference():
    ...
    W = "/data/volume/sinyu/Exp13/103_0.28616_0.62040.h5"
    # W = sorted(glob(join(W_path, "*")))[-1]

    model = EffB4Unetpp_v2((IMG_SIZE, IMG_SIZE, 1), ch=16)
    ...
    for i, f in enumerate(test_files):
        ...
        if PATCH_TRAIN:
            ...
            pred_assemble[pred_assemble >=(1/9)] = 1.
            pred_assemble[pred_assemble <(1/9)] = 0.
            ...
            for i in range(8):
                ...
                upsample_img[upsample_img < .5] = 0.
                upsample_img[upsample_img >= .5] = 255.
