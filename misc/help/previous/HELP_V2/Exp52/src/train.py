...
def train(REG_DIR=None):
    ...
    TRAIN_DIR = "/data/train"
    if REG_DIR is None:
        REG_DIR = "/data/volume/sinyu/Exp51/EXP51_REG"
    ...
    train_loader = S3DataLoader("train", TRAIN_DIR, REG_DIR, BATCH_SIZE, IMAGE_SIZE, CH3)
    valid_loader = S3DataLoader("valid", TRAIN_DIR, REG_DIR, BATCH_SIZE, IMAGE_SIZE, CH3)

    # model = CUnet((IMAGE_SIZE, IMAGE_SIZE, 19), k=3, ch=CH)
    # model = CUnet_light((IMAGE_SIZE, IMAGE_SIZE, 19), k=3, ch=CH)
    model = CoEffB4Unetpp((IMAGE_SIZE[0], IMAGE_SIZE[1], 11), ch=CH)
...
if __name__ == "__main__":
    ...
    REG_DIR = "/data/volume/sinyu/Exp51/EXP51_REG"
    # SEG_DIR = "/data/volume/sinyu/Exp51/EXP51_SEG"
