...
def train():
    ...
    train_loader = SDataLoader("train", TRAIN_DIR, BATCH_SIZE, IMAGE_SIZE, True)
    valid_loader = SDataLoader("valid", TRAIN_DIR, BATCH_SIZE, IMAGE_SIZE, True)

    model = CoEffB4Unetpp_ASPP((IMAGE_SIZE, IMAGE_SIZE, 1), ch=CH, n_classes=8)
    # model.load_weights("/data/volume/sinyu/Exp25/200_0.28987_0.57831.h5")
