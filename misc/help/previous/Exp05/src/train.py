...
from utils import CustomCallbacks, bce_dice_loss, iou_metric, bce_dice_focal_loss, dice_loss, focal_loss, weighted_ce, wbce_dice_loss
...
def train():
    ...
    model.compile(
        ...
        metrics=['binary_crossentropy', weighted_ce, dice_loss, iou_metric]
    )
    ...
    # )
    # model.save(join(LOG_DIR, f"{VER}_1.h5"), save_format="h5")
