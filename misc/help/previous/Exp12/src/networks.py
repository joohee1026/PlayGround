...
def EffB5Unetpp(input_shape=(None, None, 1), ch=16, cbam=False, n_classes=9):
    encoder = EfficientNetB5(input_shape=input_shape, weights=None, include_top=False)
    inputs = encoder.input

    # print_layer_info(encoder)
    n0 = "block7c_add" # 16,16,512
    n1 = "block5g_add" # 32,32,176
    n2 = "block3e_add" # 64,64,64
    n3 = "block2e_add" # 128,128,40
    n4 = "block1c_add" # 256,256,24
