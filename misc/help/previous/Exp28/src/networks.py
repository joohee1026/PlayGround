...
def DeepLabV3p_Xc(input_shape=(None, None, 1), output_stride=8, n_classes=1):
    if output_stride == 8:
...
def EffB4Unetpp_ASPP(input_shape=(None,None,1), ch=16, module="cbam", dout=.1, n_classes=8):
    ...
    conv0_t1, conv0_t2, conv0_t3 = TransposeConvBlock(conv0, ch*8, 3, module, reduce_dim=True)
    ...
    conv1_t1, conv1_t2 = TransposeConvBlock(conv1, ch*4, 2, module, reduce_dim=True)
    ...
    conv2_t1 = TransposeConvBlock(conv2, ch*2, 1, module, reduce_dim=True)
    ...
    conv3 = TransposeConvBlock(conv3, ch, 1, module, reduce_dim=True)
...
def CoEffB4Unetpp_ASPP(input_shape=(None,None,1), ch=16, module="cbam", dout=.1, n_classes=8):
