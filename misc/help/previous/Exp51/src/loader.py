...
class RSDataLoader(Sequence):
    def __init__(self,
        ...
        super(RSDataLoader, self).__init__()
        ...
        if mode == "train":
            ...
            self.image_paths = image_paths[:valid_length]
            self.mask_paths = image_paths[:valid_length]
        self.indexes = np.arange(len(self.image_paths))
        self.on_epoch_end()
        self.get_augment()
        self.input_shape = (input_size, input_size, 3 if ch3 else 1)
